const hikeList = [
  ...
  export default class Hikes {
    constructor(elementId) {
      ...
      // we need a back button to return back to the list. This will build it 
      // and hide it. When we need it we just need to remove the 'hidden' class
      this.backButton = this.buildBackButton();
    }
    // why is this function necessary?  hikeList is not exported, and so it cannot 
    // be seen outside of this module. I added this in case I ever need the list of 
    // hikes outside of the module. This also sets me up nicely if my data were to 
    // move. I can just change this method to the new source and everything will 
    ...
    // a listener AFTER the list of hikes has been built. The function below does 
    // that.
    addHikeListener() {
      // We need to loop through the children of our list and attach a listener 
      // to each, remember though that children is a nodeList...not an array. 
  ...
  // They don't really need to be, and by moving them outside of the exported
  // class, they cannot be called outside the module...they become private.
